  ...
  return (
    <div className="rounded-2xl shadow-lg bg-white sm:w-5/6 w-full flex-grow my-10 flex flex-col">
      ...
      <section className="my-4 sm:mx-0 mx-4 flex-grow ">
        <h1 className="mx-auto text-center text-4xl font-semibold text-gray-800 my-10">
          How to Use:
        </h1>
        <div className="px-16 my-auto mx-auto text-2xl font-semibold text-center pb-16">
